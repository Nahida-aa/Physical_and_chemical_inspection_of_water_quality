...
时间加权平均容许浓度(PC-TWA, Permissible concentration-Time Weighted Average): 指以时间为权数规定的8小时工作日、40小时工作周的平均容许接触浓度

最高容许浓度(MAC, Maximum Allowable Concentration): 指工作地点、在一个工作日内、任何时间有毒化学物质均不应该超过的浓度

短时间接触容许浓度(PC-STEL, Permissible concentration-Short Term Exposure Limit): 指一个工作日内任何一次接触不得超过的15min时间加权平均的容许接触水平
